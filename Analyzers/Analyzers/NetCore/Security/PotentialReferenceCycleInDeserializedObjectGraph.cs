...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5362";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.PotentialReferenceCycleInDeserializedObjectGraphTitle,
            Messages.PotentialReferenceCycleInDeserializedObjectGraphMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.PotentialReferenceCycleInDeserializedObjectGraphDescription,
