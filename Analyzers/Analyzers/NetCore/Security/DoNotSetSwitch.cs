...
{
    /// <summary>
    /// CA5361: <inheritdoc cref="DoNotDisableSchUseStrongCrypto"/>
    /// CA5378: <inheritdoc cref="DoNotDisableUsingServicePointManagerSecurityProtocolsTitle"/>
    ...
    public sealed class DoNotSetSwitch : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DoNotDisableSchUseStrongCryptoRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5361",
            Messages.DoNotDisableSchUseStrongCrypto,
            Messages.DoNotDisableSchUseStrongCryptoMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: false,
            descriptionResourceStringName: Messages.DoNotDisableSchUseStrongCryptoDescription);
        ...
        internal static readonly DiagnosticDescriptor DoNotDisableSpmSecurityProtocolsRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5378",
            Messages.DoNotDisableUsingServicePointManagerSecurityProtocolsTitle,
            Messages.DoNotDisableUsingServicePointManagerSecurityProtocolsMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isReportedAtCompilationEnd: false,
            isDataflowRule: true);
