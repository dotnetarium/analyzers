...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public sealed class UseAutoValidateAntiforgeryToken : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor UseAutoValidateAntiforgeryTokenRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5391",
            Messages.UseAutoValidateAntiforgeryToken,
            Messages.UseAutoValidateAntiforgeryTokenMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: false,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.UseAutoValidateAntiforgeryTokenDescription);

        internal static readonly DiagnosticDescriptor MissHttpVerbAttributeRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5395",
            Messages.MissHttpVerbAttribute,
            Messages.MissHttpVerbAttributeMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: false,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.MissHttpVerbAttributeDescription);
