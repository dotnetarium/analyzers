...
namespace Microsoft.NetCore.Analyzers.Security
{
    public abstract class UseXmlReaderBase : DiagnosticAnalyzer
    {
        ...
        protected static LocalizableString Description { get; } = Messages.UseXmlReaderDescription;

        protected static LocalizableString Message { get; } = Messages.UseXmlReaderMessage;
