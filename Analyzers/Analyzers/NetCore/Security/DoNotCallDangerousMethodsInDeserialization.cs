...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5360";
        ...
        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.DoNotCallDangerousMethodsInDeserializationTitle,
            Messages.DoNotCallDangerousMethodsInDeserializationMessage,
            DiagnosticCategory.Security,
            RuleLevel.IdeHidden_BulkConfigurable,
            description: Messages.DoNotCallDangerousMethodsInDeserializationDescription,
