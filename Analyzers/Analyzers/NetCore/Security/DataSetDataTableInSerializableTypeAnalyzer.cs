...
{
    /// <summary>
    /// CA2352: <inheritdoc cref="DataSetDataTableInRceSerializableTypeTitle"/>
    /// CA2353: <inheritdoc cref="DataSetDataTableInSerializableTypeTitle"/>
    ...
    public abstract class DataSetDataTableInSerializableTypeAnalyzer : DiagnosticAnalyzer
    {
        ...
        internal static readonly DiagnosticDescriptor RceSerializableContainsDangerousType =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2352",
                Messages.DataSetDataTableInRceSerializableTypeTitle,
                Messages.DataSetDataTableInRceSerializableTypeMessage,
                RuleLevel.Disabled,
        ...
        internal static readonly DiagnosticDescriptor SerializableContainsDangerousType =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2353",
                Messages.DataSetDataTableInSerializableTypeTitle,
                Messages.DataSetDataTableInSerializableTypeMessage,
                RuleLevel.Disabled,
                isPortedFxCopRule: false,
                isDataflowRule: false,
                isReportedAtCompilationEnd: false);
        ...
        internal static readonly DiagnosticDescriptor RceAutogeneratedSerializableContainsDangerousType =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2362",
                Messages.DataSetDataTableInRceAutogeneratedSerializableTypeTitle,
                Messages.DataSetDataTableInRceAutogeneratedSerializableTypeMessage,
                RuleLevel.Disabled,
                isPortedFxCopRule: false,
                isDataflowRule: false,
                isReportedAtCompilationEnd: false);
                ...
                (CompilationStartAnalysisContext compilationStartAnalysisContext) =>
                {
                    ...
                    compilationStartAnalysisContext.RegisterSymbolAction(
                        (SymbolAnalysisContext symbolAnalysisContext) =>
                        {
                            ...
                            bool hasSerializableAttribute = namedTypeSymbol.HasAnyAttribute(serializableAttributeTypeSymbol);

                            bool hasDataContractAttribute = namedTypeSymbol.HasAnyAttribute(dataContractAttributeTypeSymbol);
                            bool hasKnownTypeAttribute = namedTypeSymbol.HasAnyAttribute(knownTypeAttributeTypeSymbol);
                            bool hasAnyIgnoreDataMemberAttribute =
                                namedTypeSymbol.GetMembers().Any(m => m.HasAnyAttribute(ignoreDataMemberTypeSymbol));
                            ...
                            bool isProbablyAutogeneratedForGuiApp =
                                namedTypeSymbol.HasAnyAttribute(designerCategoryAttributeTypeSymbol)
