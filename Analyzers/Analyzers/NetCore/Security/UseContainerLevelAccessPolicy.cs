...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5377";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.UseContainerLevelAccessPolicy,
            Messages.UseContainerLevelAccessPolicyMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.UseContainerLevelAccessPolicyDescription,
