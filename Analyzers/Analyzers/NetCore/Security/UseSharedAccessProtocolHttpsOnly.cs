...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5376";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.UseSharedAccessProtocolHttpsOnly,
            Messages.UseSharedAccessProtocolHttpsOnlyMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.UseSharedAccessProtocolHttpsOnlyDescription,
