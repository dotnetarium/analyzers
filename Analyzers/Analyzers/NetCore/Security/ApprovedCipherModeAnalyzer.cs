...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5358";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.ApprovedCipherMode,
            Messages.ApprovedCipherModeMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.ApprovedCipherModeDescription,
