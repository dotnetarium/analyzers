...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public sealed class UseDefaultDllImportSearchPathsAttribute : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor UseDefaultDllImportSearchPathsAttributeRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5392",
            Messages.UseDefaultDllImportSearchPathsAttribute,
            Messages.UseDefaultDllImportSearchPathsAttributeMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: false,
            isReportedAtCompilationEnd: false,
            descriptionResourceStringName: Messages.UseDefaultDllImportSearchPathsAttributeDescription);
        ...
        internal static readonly DiagnosticDescriptor DoNotUseUnsafeDllImportSearchPathRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5393",
            Messages.DoNotUseUnsafeDllImportSearchPath,
            Messages.DoNotUseUnsafeDllImportSearchPathMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: false,
            isReportedAtCompilationEnd: false,
            descriptionResourceStringName: Messages.DoNotUseUnsafeDllImportSearchPathDescription);
