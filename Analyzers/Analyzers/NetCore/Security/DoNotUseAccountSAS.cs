...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5375";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.DoNotUseAccountSAS,
            Messages.DoNotUseAccountSASMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.DoNotUseAccountSASDescription,
