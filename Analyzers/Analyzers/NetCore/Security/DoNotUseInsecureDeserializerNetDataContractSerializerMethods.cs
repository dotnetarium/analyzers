    ...
    internal class DoNotUseInsecureDeserializerNetDataContractSerializerMethods : DoNotUseInsecureDeserializerMethodsBase
    {
        internal static readonly DiagnosticDescriptor RealMethodUsedDescriptor =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2310",
                Messages.NetDataContractSerializerMethodUsedTitle,
                Messages.NetDataContractSerializerMethodUsedMessage,
                RuleLevel.Disabled,
                isPortedFxCopRule: false,
                isDataflowRule: false,
                isReportedAtCompilationEnd: false,
                descriptionResourceStringName: Messages.NetDataContractSerializerMethodUsedDescription);
