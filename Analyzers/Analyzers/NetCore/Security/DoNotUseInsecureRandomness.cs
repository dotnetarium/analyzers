...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5394";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.DoNotUseInsecureRandomness,
            Messages.DoNotUseInsecureRandomnessMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.DoNotUseInsecureRandomnessDescription,
