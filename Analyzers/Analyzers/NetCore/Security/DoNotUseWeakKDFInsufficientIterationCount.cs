...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public sealed class DoNotUseWeakKDFInsufficientIterationCount : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DefinitelyUseWeakKDFInsufficientIterationCountRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5387",
            Messages.DefinitelyUseWeakKDFInsufficientIterationCount,
            Messages.DefinitelyUseWeakKDFInsufficientIterationCountMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.DoNotUseWeakKDFInsufficientIterationCountDescription);
        ...
        internal static readonly DiagnosticDescriptor MaybeUseWeakKDFInsufficientIterationCountRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5388",
            Messages.MaybeUseWeakKDFInsufficientIterationCount,
            Messages.MaybeUseWeakKDFInsufficientIterationCountMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
