...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DoNotUseWeakCryptographyRuleId = "DN5350";
        internal const string DoNotUseBrokenCryptographyRuleId = "DN5351";

        internal static readonly DiagnosticDescriptor DoNotUseBrokenCryptographyRule =
            DiagnosticDescriptorHelper.Create(
                DoNotUseBrokenCryptographyRuleId,
                Messages.DoNotUseBrokenCryptographicAlgorithms,
                Messages.DoNotUseBrokenCryptographicAlgorithmsMessage,
                DiagnosticCategory.Security,
                RuleLevel.IdeHidden_BulkConfigurable,
                description: Messages.DoNotUseBrokenCryptographicAlgorithmsDescription,
        ...
        internal static readonly DiagnosticDescriptor DoNotUseWeakCryptographyRule =
            DiagnosticDescriptorHelper.Create(
                ...
                Messages.DoNotUseWeakCryptographicAlgorithms,
                Messages.DoNotUseWeakCryptographicAlgorithmsMessage,
                DiagnosticCategory.Security,
                RuleLevel.IdeHidden_BulkConfigurable,
                description: Messages.DoNotUseWeakCryptographicAlgorithmsDescription,
                isPortedFxCopRule: false,
                isDataflowRule: false);
