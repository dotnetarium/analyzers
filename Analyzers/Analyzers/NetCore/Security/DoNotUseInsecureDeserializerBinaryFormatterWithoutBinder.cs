    ...
    public class DoNotUseInsecureDeserializerBinaryFormatterWithoutBinder : DoNotUseInsecureDeserializerWithoutBinderBase
    {
        internal static readonly DiagnosticDescriptor RealBinderDefinitelyNotSetDescriptor =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2301",
                Messages.BinaryFormatterDeserializeWithoutBinderSetTitle,
                Messages.BinaryFormatterDeserializeWithoutBinderSetMessage,
                RuleLevel.Disabled,
        ...
        internal static readonly DiagnosticDescriptor RealBinderMaybeNotSetDescriptor =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2302",
                Messages.BinaryFormatterDeserializeMaybeWithoutBinderSetTitle,
                Messages.BinaryFormatterDeserializeMaybeWithoutBinderSetMessage ,
                RuleLevel.Disabled,
                isPortedFxCopRule: false,
                isDataflowRule: true,
                isReportedAtCompilationEnd: true);
