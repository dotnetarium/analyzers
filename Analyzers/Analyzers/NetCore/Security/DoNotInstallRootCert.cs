...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal static readonly DiagnosticDescriptor DefinitelyInstallRootCertRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5380",
            Messages.DefinitelyInstallRootCert,
            Messages.DefinitelyInstallRootCertMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.DoNotInstallRootCertDescription);

        internal static readonly DiagnosticDescriptor MaybeInstallRootCertRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5381",
            Messages.MaybeInstallRootCert,
            Messages.MaybeInstallRootCertMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
                            ...
                            operationBlockStartAnalysisContext.RegisterOperationAction(
                                (OperationAnalysisContext operationAnalysisContext) =>
                                {
                                    ...
                                    if (argumentOperation.Parameter != null &&
                                        x509TypeSymbol.Equals(argumentOperation.Parameter.Type))
                                    {
                                        lock (rootOperationsNeedingAnalysis)
                                        {
