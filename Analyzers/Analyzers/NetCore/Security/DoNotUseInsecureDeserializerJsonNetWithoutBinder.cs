    ...
    internal class DoNotUseInsecureDeserializerJsonNetWithoutBinder : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DefinitelyInsecureSerializer =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2329",
                Messages.JsonNetInsecureSerializerTitle,
                Messages.JsonNetInsecureSerializerMessage,
                RuleLevel.Disabled,
        ...
        internal static readonly DiagnosticDescriptor MaybeInsecureSerializer =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2330",
                Messages.JsonNetMaybeInsecureSerializerTitle,
                Messages.JsonNetMaybeInsecureSerializerMessage,
                RuleLevel.Disabled,
                isPortedFxCopRule: false,
                isDataflowRule: true,
                isReportedAtCompilationEnd: true);
