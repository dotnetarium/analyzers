...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public sealed class DoNotUseDeprecatedSecurityProtocols : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DeprecatedRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5364",
            Messages.DoNotUseDeprecatedSecurityProtocols,
            Messages.DoNotUseDeprecatedSecurityProtocolsMessage,
            RuleLevel.IdeHidden_BulkConfigurable,
            isPortedFxCopRule: false,
            isDataflowRule: false,
            isReportedAtCompilationEnd: false,
            descriptionResourceStringName: Messages.DoNotUseDeprecatedSecurityProtocolsDescription);

        internal static readonly DiagnosticDescriptor HardCodedRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5386",
            Messages.HardCodedSecurityProtocolTitle,
            Messages.HardCodedSecurityProtocolMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: false,
            isReportedAtCompilationEnd: false);
