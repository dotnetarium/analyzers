    ...
    public sealed class DoNotUseInsecureSettingsForJsonNet : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DefinitelyInsecureSettings =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2327",
                Messages.JsonNetInsecureSettingsTitle,
                Messages.JsonNetInsecureSettingsMessage,
                RuleLevel.Disabled,
        ...
        internal static readonly DiagnosticDescriptor MaybeInsecureSettings =
            SecurityHelpers.CreateDiagnosticDescriptor(
                "DN2328",
                Messages.JsonNetMaybeInsecureSettingsTitle,
                Messages.JsonNetMaybeInsecureSettingsMessage,
                RuleLevel.Disabled,
                isPortedFxCopRule: false,
                isDataflowRule: true,
                isReportedAtCompilationEnd: true);
