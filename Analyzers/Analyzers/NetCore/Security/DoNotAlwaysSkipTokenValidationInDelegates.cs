...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5405";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
                DiagnosticId,
                Messages.DoNotAlwaysSkipTokenValidationInDelegatesTitle,
                Messages.DoNotAlwaysSkipTokenValidationInDelegatesMessage,
                DiagnosticCategory.Security,
                RuleLevel.Disabled,
                description: Messages.DoNotAlwaysSkipTokenValidationInDelegatesDescription,
