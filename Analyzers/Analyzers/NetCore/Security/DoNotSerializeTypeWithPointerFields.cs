...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal const string DiagnosticId = "DN5367";

        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            DiagnosticId,
            Messages.DoNotSerializeTypesWithPointerFields,
            Messages.DoNotSerializeTypesWithPointerFieldsMessage,
            DiagnosticCategory.Security,
            RuleLevel.Disabled,
            description: Messages.DoNotSerializeTypesWithPointerFieldsDescription,
