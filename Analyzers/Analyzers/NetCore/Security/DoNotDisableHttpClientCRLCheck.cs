...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    internal class DoNotDisableHttpClientCRLCheck : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DefinitelyDisableHttpClientCRLCheckRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5399",
            Messages.DefinitelyDisableHttpClientCRLCheck,
            Messages.DefinitelyDisableHttpClientCRLCheckMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.DoNotDisableHttpClientCRLCheckDescription);
        ...
        internal static readonly DiagnosticDescriptor MaybeDisableHttpClientCRLCheckRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5400",
            Messages.MaybeDisableHttpClientCRLCheck,
            Messages.MaybeDisableHttpClientCRLCheckMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
