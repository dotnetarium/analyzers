...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public class ReviewCodeForInformationDisclosureVulnerabilities : SourceTriggeredTaintedDataAnalyzerBase
    {
        internal static readonly DiagnosticDescriptor Rule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN3004",
            Messages.ReviewCodeForInformationDisclosureVulnerabilitiesTitle,
            Messages.ReviewCodeForInformationDisclosureVulnerabilitiesMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: false);

        protected override SinkKind SinkKind => SinkKind.InformationDisclosure;
