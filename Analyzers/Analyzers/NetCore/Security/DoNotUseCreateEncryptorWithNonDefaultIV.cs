...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public sealed class DoNotUseCreateEncryptorWithNonDefaultIV : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor DefinitelyUseCreateEncryptorWithNonDefaultIVRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5401",
            Messages.DefinitelyUseCreateEncryptorWithNonDefaultIV,
            Messages.DefinitelyUseCreateEncryptorWithNonDefaultIVMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.DoNotUseCreateEncryptorWithNonDefaultIVDescription);
        ...
        internal static readonly DiagnosticDescriptor MaybeUseCreateEncryptorWithNonDefaultIVRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5402",
            Messages.MaybeUseCreateEncryptorWithNonDefaultIV,
            Messages.MaybeUseCreateEncryptorWithNonDefaultIVMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
