...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    {
        internal static readonly DiagnosticDescriptor DefinitelyUseSecureCookiesASPNetCoreRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5382",
            Messages.DefinitelyUseSecureCookiesASPNetCore,
            Messages.DefinitelyUseSecureCookiesASPNetCoreMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
            descriptionResourceStringName: Messages.UseSecureCookiesASPNetCoreDescription);

        internal static readonly DiagnosticDescriptor MaybeUseSecureCookiesASPNetCoreRule = SecurityHelpers.CreateDiagnosticDescriptor(
            "DN5383",
            Messages.MaybeUseSecureCookiesASPNetCore,
            Messages.MaybeUseSecureCookiesASPNetCoreMessage,
            RuleLevel.Disabled,
            isPortedFxCopRule: false,
            isDataflowRule: true,
            isReportedAtCompilationEnd: true,
